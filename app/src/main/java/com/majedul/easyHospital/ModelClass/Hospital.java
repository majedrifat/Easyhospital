package com.majedul.easyHospital.ModelClass;
...
public class Hospital {
    ...
    public Hospital(String h_name, String h_status, String h_open, String h_phone, int h__img, String[] hospitaldoctor) {
        this.h_name = h_name;
